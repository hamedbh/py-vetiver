.PHONY: all data pipeline model requirements clean lint help test_environment

## Build the whole pipeline
all: data pipeline model requirements clean lint

PROJECT_DIR := $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))
PROFILE = default
PROJECT_NAME = py-vetiver
...
## Create a scikit-learn data preprocessing pipeline from the source data
